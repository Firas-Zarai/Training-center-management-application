...
private JPanel createRightPanel() {
		...
		public String nomFormation() {
			String sql = "select NomF from formations where salle='salle1' and Jour='Lundi' and Horaire='13h à 16h'";
		...
		public String nomFormateur() {
			String sql = "select NomFor, Email from formateurs where NomF in (select NomF from formations where salle='salle1' and Jour='Lundi' and Horaire='13h à 16h')";
		...
		public void listeClients() {
			...
			String sql = "select Nom, Prenom from clients where NomF in (select NomF from formations where salle='salle1' and Jour='Lundi' and Horaire='13h à 16h')";
