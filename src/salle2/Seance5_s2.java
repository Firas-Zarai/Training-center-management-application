...
private JPanel createRightPanel() {
		...
		public String nomFormation() {
			String sql = "select NomF from formations where salle='salle2' and Jour='Mercredi' and Horaire='8h à 12h'";
		...
		public String nomFormateur() {
			String sql = "select NomFor, Email from formateurs where NomF in (select NomF from formations where salle='salle2' and Jour='Mercredi' and Horaire='8h à 12h')";
		...
		public void listeClients() {
			...
			String sql = "select Nom, Prenom from clients where NomF in (select NomF from formations where salle='salle2' and Jour='Mercredi' and Horaire='8h à 12h')";
